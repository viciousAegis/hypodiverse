...
SYMMETRY_STRATIFIED="${SYMMETRY_STRATIFIED:-0}"
SYMMETRY_SEED="${SYMMETRY_SEED:-1}"
...
if [[ "$SYMMETRY_STRATIFIED" == "1" ]]; then
  ARGS+=(--symmetry-stratified --symmetry-seed "$SYMMETRY_SEED")
fi
