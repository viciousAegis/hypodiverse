...
KEY_MAP = {
    ...
    # Canonical LIFPO names map to the frozen implementation contract.
    "lifpo_frequency_epsilon": "LIFPO_FREQUENCY_EPSILON",
    "lifpo_probe_fraction": "LIFPO_PROBE_FRACTION",
    "lifpo_length_penalty_start": "LIFPO_LENGTH_PENALTY_START",
    "lifpo_latent_enabled": "LIFPO_LATENT_ENABLED",
    "lifpo_latent_count": "LIFPO_LATENT_COUNT",
    "lifpo_negative_offset": "LIFPO_NEGATIVE_OFFSET",
    "lifpo_counterfactual_alpha": "LIFPO_COUNTERFACTUAL_ALPHA",
    "lifpo_counterfactual_clip": "LIFPO_COUNTERFACTUAL_CLIP",
    "lifpo_counterfactual_token_scope": "LIFPO_COUNTERFACTUAL_TOKEN_SCOPE",
    "lifpo_counterfactual_reduction": "LIFPO_COUNTERFACTUAL_REDUCTION",
    "lifpo_counterfactual_valid_only": "LIFPO_COUNTERFACTUAL_VALID_ONLY",
    "lifpo_inverse_frequency_enabled": "LIFPO_INVERSE_FREQUENCY_ENABLED",
    "lifpo_frequency_credit_mode": "LIFPO_FREQUENCY_CREDIT_MODE",
    "lifpo_frequency_credit_max": "LIFPO_FREQUENCY_CREDIT_MAX",
    "max_steps": "MAX_STEPS",
    ...
    "initial_mode_counts": "INITIAL_MODE_COUNTS",
    "trajectories_per_count": "TRAJECTORIES_PER_COUNT",
    "closed_loop_resume": "CLOSED_LOOP_RESUME",
    "deduplicate_planner_modes": "DEDUPLICATE_PLANNER_MODES",
