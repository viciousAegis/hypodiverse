...
export BLACKWELL_SCRATCH_BASE="/scratch/$BLACKWELL_USER"
export BLACKWELL_RUN_ROOT="$BLACKWELL_SCRATCH_BASE/open-discovery"

export CACHE_ROOT="$BLACKWELL_RUN_ROOT/.cache"
export ARTIFACT_ROOT="$BLACKWELL_RUN_ROOT/artifacts"
export DATA_ROOT="$BLACKWELL_RUN_ROOT/data"
export CHECKPOINT_ROOT="$BLACKWELL_RUN_ROOT/checkpoints"
export MODEL_ROOT="$BLACKWELL_RUN_ROOT/models"
export VENV_DIR="${VENV_DIR:-$REPO_DIR/.venv}"
export WANDB_DIR="$BLACKWELL_RUN_ROOT/.wandb"
export TMPDIR="$BLACKWELL_RUN_ROOT/tmp"
export RAY_TMPDIR="$BLACKWELL_RUN_ROOT/ray-tmp"
